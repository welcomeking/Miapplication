...
public class FullscreenDrawerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(daedalusdigital.miapplication.app.R.layout.activity_sample_fullscreen_dark_toolbar);
        ...
        getSupportActionBar().setTitle(daedalusdigital.miapplication.app.R.string.drawer_item_fullscreen_drawer);
