...
public class ActionBarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(daedalusdigital.miapplication.app.R.layout.activity_sample_actionbar);
        setTitle(daedalusdigital.miapplication.app.R.string.drawer_item_action_bar_drawer);
        ...
        result = new DrawerBuilder()
                ...
                .withDrawerLayout(daedalusdigital.miapplication.app.R.layout.material_drawer_fits_not)
                .addDrawerItems(
